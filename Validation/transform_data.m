...
save('dataSet/All_1camera/no_pressure/input_train','input_train',"-v7.3")
save('dataSet/All_1camera/no_pressure/input_test','input_test',"-v7.3")
save('dataSet/All_1camera/no_pressure/target_train','target_train',"-v7.3")
save('dataSet/All_1camera/no_pressure/target_test','target_test',"-v7.3")
