clear
%% Import datasets
load("dataSet/All_1camera/input_train.mat")
load("dataSet/All_1camera/target_train.mat")

load("dataSet/All_1camera/input_test.mat")
load("dataSet/All_1camera/target_test.mat")
disp("Finished importing data.")

A = exist('input_p_train');
if A == 1
