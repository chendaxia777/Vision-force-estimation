...
for i = 1 : length
    ...
    images_p(:,:,:,i) = asd + pressure_mat/1.2; %pressure range to 1.2bar
...
% shuffle the dataset
[~, ~, ~, data_num] = size(input_p);
data_idx = randperm(data_num);
input_p = input_p(:,:,:,data_idx);
...
input_p_train = input_p(:,:,:,1:train_num);
input_p_test = input_p(:,:,:,train_num+1:end);
...
save('DataSets/2023.5.19/with_y_minus/input_train','input_p_train',"-v7.3")
save('DataSets/2023.5.19/with_y_minus/input_test','input_p_test',"-v7.3")
save('DataSets/2023.5.19/with_y_minus/target_train','target_train',"-v7.3")
save('DataSets/2023.5.19/with_y_minus/target_test','target_test',"-v7.3")

save('DataSets/2023.5.19/no_pressure/input_train','input_train',"-v7.3")
save('DataSets/2023.5.19/no_pressure/input_test','input_test',"-v7.3")
save('DataSets/2023.5.19/no_pressure/target_train','target_train',"-v7.3")
save('DataSets/2023.5.19/no_pressure/target_test','target_test',"-v7.3")
